...
//
// The difference between postincrementing and preincrementing is postincrementing is after it already happened, and
// preincrementing is before the incrementing starts.
